...
const config = useRuntimeConfig().public.feedback;
const typeItems = [
...
const schema = z.object({
  ...
  message: z.string().trim().min(1, "Please enter a message").max(5e3, "Message is too long (5000 characters max)"),
